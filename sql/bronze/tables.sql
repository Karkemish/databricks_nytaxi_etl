...
CREATE TABLE IF NOT EXISTS dev.bronze.raw_taxi_trip_yellow (
    ...
    tip_amount DECIMAL(10, 2) COMMENT 'Tip amount (credit card tips only, cash tips not included)',
    ...
    total_amount DECIMAL(10, 2) COMMENT 'Total amount charged to passengers (does not include cash tips)',
...
CREATE TABLE IF NOT EXISTS dev.bronze.raw_taxi_trip_green (
    ...
    tip_amount DECIMAL(10, 2) COMMENT 'Tip amount (credit card tips only, cash tips not included)',
    tolls_amount DECIMAL(10, 2) COMMENT 'Total amount of all tolls paid during the trip',
    ehail_fee DECIMAL(10, 2) COMMENT 'E-hail service fee (Specific to Green Taxis)',
    improvement_surcharge DECIMAL(10, 2) COMMENT 'Improvement surcharge assessed on hailed trips',
    total_amount DECIMAL(10, 2) COMMENT 'Total amount charged to passengers (does not include cash tips)',
    payment_type DOUBLE COMMENT 'Payment method code (1=Credit card, 2=Cash, 3=No charge, 4=Dispute, 5=Unknown, 6=Voided)',
    -- Columnas de Auditoría Obligatorias (Control del Lago)
